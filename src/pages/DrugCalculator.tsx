...
const DrugCalculator = () => {
  ...
  const [category, setCategory] = useState<"nutrition" | "endocrine" | "rheumatic">("nutrition");
  ...
  const calculateDose = () => {
    ...
    const drug = [...nutritionDrugs, ...endocrineDrugs, ...rheumaticDrugs].find(
      ...
      <div className="pt-16 p-4 max-w-md mx-auto space-y-6">
        <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
          <div className="space-y-2">
            ...
            <Select
              value={category}
              onValueChange={(value: "nutrition" | "endocrine" | "rheumatic") =>
                setCategory(value)
              }
            >
